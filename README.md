...
1. Clone this repository:
   ```sh
   git clone https://github.com/subhajit-maji/free-freefire-like-bot
...
6. Paste both values into your `.env` file:
   ...
   ```
6. If you don't have api like you can go to rapid api to create account in link  `.env` file: https://rapidapi.com/subhajitmaji/api/free-fire-like1
      ```ini
...
1. Go to [Free Fire Like API on RapidAPI](https://rapidapi.com/subhajitmaji/api/free-fire-like1).
...
1. Host your own version of the API: [Free Fire Like api](https://github.com/subhajit-maji/free-api-like-freefire).
...
## Example Output
![image](https://github.com/user-attachments/assets/ae73e78c-cb1b-4ch4-8795-474ba685mk06)
